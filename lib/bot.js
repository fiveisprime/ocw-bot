...
//
// Specify a search criteria to find texts with that word.
//
Bot.prototype.sayText = function (search) {
  if (search) {
    var filtered = texts.filter(function (text) {
...
// Specify a search criteria to find texts with that word.
//
Bot.prototype.sayWat = function(search) {
  if (search) {
    var filtered = wat.filter(function (text) {
      return text.indexOf(search) >= 0;
    });
